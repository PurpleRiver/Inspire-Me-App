...
class RemaindesTableViewController: UITableViewController {
    ...
    @IBAction func startAtStepper(_ sender: UIStepper) {
        startAtLabel.text = String(Int(sender.value))
    }
    @IBAction func endAtStepper(_ sender: UIStepper) {
        endAtLabel.text = String(Int(sender.value))
    }
